  ...
  var _private = {
    ...
    tabsInit: function(_that) {
      ...
      const tpl_title = [
        ...
        '      <li lay-id="1" class="layui-this" data-path="#/admin/index/dashboard.html">',
        ...
        '        <a href="#/admin/index/dashboard.html" title="主页">',
        '          <span>主页</span>',
        '        </a>',
        '      </li>',
        '    </ul>',
      ...
      const tpl_content = [
        ...
        '  <div class="kit-tabs-item layui-show" data-rendered="false" data-path="#/admin/index/dashboard.html" lay-tab-id="1">',
