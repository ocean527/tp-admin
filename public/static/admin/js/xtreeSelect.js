...
layui.define(['jquery'], function (exports) {
    ...
    layuiXtree.prototype.Rendering = function () {
        ...
        if (typeof(_this._options.done) == "function") {
            _this._options.done();
        }
    }
    ...
    layuiXtree.prototype.setChecked = function (checkedArr) {
        var _private = {
            checkValue: function(data, arr) {
                for (let i = 0; i < data.length; i++) {
                    if (data[i].data.length > 0) {
                        this.checkValue(data[i].data, arr);
                    } else {
        ...
        var _this = this;
        _private.checkValue(_this._dataJson, checkedArr);
        _this._options.done = undefined;
        _this._options.data = _this._dataJson;
        _this.Loading(_this._options);
    }

    //var xtreeSelect = new layuiXtree();
    //暴露接口
    exports("xtreeSelect", layuiXtree);
